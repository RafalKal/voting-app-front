...
const MultipleChoiceScreenEdit = () => {
  ...
  const handleSave = () => {
    ...
    updatedQuestions[questionIndex] = newQuestionData;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Wybór wielokrotny</Text>
...
export default MultipleChoiceScreenEdit;
