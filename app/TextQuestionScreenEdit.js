...
const TextQuestionScreenEdit = () => {
  ...
  const { questionIndex, questions, name } = route.params;

  useEffect(() => {
    if (questions && questionIndex !== undefined && questions[questionIndex]) {
      setQuestionContent(questions[questionIndex].questionContent);
      setIsAnswerRequired(questions[questionIndex].isAnswerRequired);
    }
...
export default TextQuestionScreenEdit;
